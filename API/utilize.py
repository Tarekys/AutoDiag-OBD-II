...
def encode_categorical_columns(data, encoders_path=None):
    """
    Encode categorical columns using LabelEncoder for binary columns and OneHotEncoder for multivalued columns.
        ...
        if multi_cols:
            if encoders_path and onehot_encoder:
                try:
                    ...
                    print(f"Warning: Values ​​in columns {multi_cols} contain new values")
